...
Bu dal, tam analyze, test, responsive ve release APK doğrulamasını çalıştırır. Tanılama çıktıları ayrı artifact olarak saklanır. Kök neden düzeltmeleriyle üçüncü tam koşu başlatıldı.
